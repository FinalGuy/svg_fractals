...
/**
 * The Lindenmayer-System (or L-System for short) for constructing the Koch-Snowflake.
 */
public final class KochSnowflakeLSystem implements LindenmayerSystem {
    ...
    private static final String INITIAL_WORD = "F--F--F";
