 ...
 */
public final class KochPentaflakeInvertedLSystem implements LindenmayerSystem {
    ...
    private static final Function<String, String> PRODUCTION_RULE = s -> s.replace(F, F + R + F + L + L + F + R + F);
